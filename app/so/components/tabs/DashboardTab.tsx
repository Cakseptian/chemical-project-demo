                            ...
                            <tr className="bg-slate-50 border-b border-slate-200">
                                ...
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        Stock
                                        <ColInfo id="stock" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                </th>
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        <div>Loan Fcst</div>
                                        <ColInfo id="loanFcst" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                ...
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        <div>Cons Fcst</div>
                                        <ColInfo id="consFcst" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                    <div className="text-[9px] font-normal normal-case tracking-normal text-slate-400 mt-0.5">per minggu</div>
                                </th>
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        Safety
                                        <ColInfo id="safety" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                </th>
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        ROP
                                        <ColInfo id="rop" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                </th>
                                <th className="text-center text-[11px] font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">
                                    <span className="inline-flex items-center justify-center gap-0.5">
                                        Params
                                        <ColInfo id="params" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
                                    </span>
                                </th>
