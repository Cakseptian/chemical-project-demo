...
export const DashboardTab = ({ inventoryList, dashboardStats, sbaAlerts, historyList }: DashboardTabProps) => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {/* 3. BOTTOM GRID: Most Borrowed + Recent Activity (Two equal side cards) */}
